 ...
 */
export declare const setRGBColor: (device: Device, red: number, green: number, blue: number) => void;
/**
 * Turn off the RGB side of your Logitech Litra Beam LX
 *
 * @param {Device} device The device to set the RGB of. Setting all to zero will turn it off.
 */
export declare const turnOnRGB: (device: Device) => void;
/**
 * Turn off the RGB side of your Logitech Litra Beam LX
 *
 */
export declare const turnOffRGB: (device: Device) => void;
/**
 * Set the RGB brightness of your Logitech Litra Beam LX (wall-side). Value is 0-100
 *
 * @param {Device} device The device to set the RGB of. Setting all to zero will turn it off.
 */
export declare const setBrightnessRGB: (device: Device, value: number) => void;
/**
 * Set the RGB brightness of your Logitech Litra Beam LX (wall-side). Value is 0-100
 *
 * @param {Device} device The device to set the RGB of. Setting all to zero will turn it off.
 */
export declare const setZoneColorRGB: (device: Device, zoneId: number, red: number, green: number, blue: number) => void;
