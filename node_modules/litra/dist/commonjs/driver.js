 ...
 */
const turnOn = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x1c, 0x01], 20, 0x00));
};
...
const turnOff = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x1c, 0x00], 20, 0x00));
};
 ...
 */
const isOn = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x01], 20, 0x00));
...
const setTemperatureInKelvin = (device, temperatureInKelvin) => {
    ...
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x9c, ...(0, utils_1.integerToBytes)(temperatureInKelvin)], 20, 0x00));
};
...
const getTemperatureInKelvin = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x81], 20, 0x00));
    const data = device.hid.readSync();
...
const setBrightnessInLumen = (device, brightnessInLumen) => {
    ...
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x4c, ...(0, utils_1.integerToBytes)(brightnessInLumen)], 20, 0x00));
};
...
const getBrightnessInLumen = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x31], 20, 0x00));
    const data = device.hid.readSync();
    return data[5];
};
 ...
 */
const setRGBColor = (device, red, green, blue) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0B, 0x5F, 1, 1], 20, 0x00));
    device.hid.readSync();
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0a, 0x4b, 1], 20, 0x00));
    device.hid.readSync();
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0a, 0x2e, 0, 100], 20, 0x00));
    device.hid.readSync();
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0b, 0x1f, 0, 0, red, green, blue, 0, 0, 0, 0, 0, 0, 0, 1], 20, 0x00));
    device.hid.readSync();
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0b, 0x1f, 0, 0, red, green, blue, 0, 0, 0, 0, 0, 0, 0, 1], 20, 0x00));
};
 ...
 * @param {Device} device The device to set the RGB of. Setting all to zero will turn it off.
 */
const turnOnRGB = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0a, 0x4b, 0], 20, 0x00));
};
exports.turnOnRGB = turnOnRGB;
/**
 * Turn off the RGB side of your Logitech Litra Beam LX
 *
 */
const turnOffRGB = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0a, 0x4b, 0], 20, 0x00));
};
exports.turnOffRGB = turnOffRGB;
/**
 * Set the RGB brightness of your Logitech Litra Beam LX (wall-side). Value is 0-100
 *
 * @param {Device} device The device to set the RGB of. Setting all to zero will turn it off.
 */
const setBrightnessRGB = (device, value) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0a, 0x2b, 0, value], 20, 0x00));
};
exports.setBrightnessRGB = setBrightnessRGB;
/**
 * Set the RGB brightness of your Logitech Litra Beam LX (wall-side). Value is 0-100
 *
 * @param {Device} device The device to set the RGB of. Setting all to zero will turn it off.
 */
const setZoneColorRGB = (device, zoneId, red, green, blue) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0C, 0x1B, zoneId, red, green, blue, 0xFF, 0, 0, 0, 0xFF, 0, 0, 0, 0xFF, 0, 0, 0], 20, 0x00));
    device.hid.readSync();
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0C, 0x7B, 0, 0, 1, 0, 0], 20, 0x00));
    device.hid.readSync();
};
exports.setZoneColorRGB = setZoneColorRGB;
