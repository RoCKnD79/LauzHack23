 ...
 */
const turnOn = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x1f, 0x01], 20, 0x00));
};
...
const turnOff = (device) => {
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x1f, 0x00], 20, 0x00));
};
...
const setTemperatureInKelvin = (device, temperatureInKelvin) => {
    ...
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x9f, ...(0, utils_1.integerToBytes)(temperatureInKelvin)], 20, 0x00));
};
...
const setBrightnessInLumen = (device, brightnessInLumen) => {
    ...
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x06, 0x4f, ...(0, utils_1.integerToBytes)(brightnessInLumen)], 20, 0x00));
};
...
const setRGBColor = (device, red, green, blue) => {
    ...
    device.hid.write((0, utils_1.padRight)([0x11, 0xff, 0x0a, 0x2e, 255, 255], 20, 0x00));
